...
See [Features](3.0/features.md) for a comprehensive list of existing, planned and precluded features.
...
You can view a simple demo online at [http://laravel-forum.teamteatime.net/](http://laravel-forum.teamteatime.net/). The demo source is available at [https://github.com/Team-Tea-Time/laravel-forum-demo](https://github.com/Team-Tea-Time/laravel-forum-demo).
