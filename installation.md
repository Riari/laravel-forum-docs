...
Installing the [front-end](docs/laravel-forum/4.x/front-end.introduction.md) is recommended. Note that version 1 of the front-end is compatible with versions 3 and 4 of the core package.
