...
* `token`: A random string used to authenticate API requests. This is used by the [API dispatcher](docs/laravel-forum/3.x/api.internal-dispatching.md) and is by default set to a random 32-character string to maximise security on a fresh install.
